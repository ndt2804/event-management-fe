...
import { useSignInAccount } from '../hooks/useAuthApi'
import { SigninValidation } from '../libs/validation/form-validation'
import { useToast } from '../context/toast-context';
import { Link } from "react-router-dom";
const SignIn = () => {
    const mutation = useSignInAccount();
                                ...
                                <Form className="space-y-4 md:space-y-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-start">
                                            ...
                                            />
                                            <label htmlFor="rememberMe" className="ml-3 text-sm text-gray-500 dark:text-gray-300">
                                                Remember me
                                            </label>
                                        </div>
                                    ...
                                    >
                                        {mutation.isPending ? <span className="loader"></span> : "Sign In"}
                                    </button>
